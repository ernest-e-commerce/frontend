    ...
    return (
      <div className="px-4 md:px-8 lg:px-16 py-16 bg-gray-50 min-h-screen flex items-center justify-center">
        <div className="max-w-2xl mx-auto text-center p-12 bg-white rounded-2xl shadow-xl border border-gray-200">
          ...
          <button
            onClick={() => navigate("/")}
            className="px-8 py-4 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition shadow-lg shadow-blue-500/40"
          >
            Continue Shopping
          </button>
        </div>
  ...
  return (
    <div className="px-4 md:px-8 lg:px-16 py-12 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-serif font-bold text-gray-800 mb-10 text-center">
          Checkout
        </h1>
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  <div
                    className={`flex items-center justify-center w-10 h-10 rounded-full ${
                      addressComplete ? "bg-green-500" : "bg-blue-600"
              ...
              {activeStep === "address" && (
                ...
                >
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full mt-6 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition shadow-lg shadow-blue-500/40 disabled:bg-blue-300"
                  >
            ...
            <div
              className={`bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden ${
                !addressComplete && "opacity-50"
              }`}
            >
              <div
                className="flex items-center justify-between p-6 cursor-pointer"
                onClick={() => addressComplete && setActiveStep("payment")}
              >
                <div className="flex items-center space-x-4">
                  <div
                    className={`flex items-center justify-center w-10 h-10 rounded-full ${
                    ...
                    <div className="mt-6 p-6 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      {paymentStatus === "pending" ? (
                        <button
                          ...
                          className="w-full mt-6 py-3 bg-green-500 text-white font-bold rounded-lg hover:bg-green-600 transition shadow-md"
                        >
                          I have paid {formatCurrency(grandTotal)}
                        </button>
                      ) : (
                        <div className="mt-6 text-center py-3 bg-yellow-100 text-yellow-800 font-bold rounded-lg">
